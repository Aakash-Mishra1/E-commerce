...
const Banner = () => {
  return (
    <div className="relative w-full h-[500px] md:h-[600px] overflow-hidden rounded-3xl mt-24 border border-white/5 mx-auto max-w-7xl">
      {/* Background with Dark Overlay - Connected Earth Theme */}
      <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=80&w=2072&auto=format&fit=crop')] bg-cover bg-center">
        ...
        {/* Additional blue tint overlay for consistency */}
      ...
      <div className="relative z-10 h-full flex flex-col justify-center px-8 md:px-20">
        ...
        <motion.h1 
          ...
          className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight max-w-2xl"
        >
          Next Gen <br/>
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-brandBlue to-softCyan">Virtual Reality</span>
        </motion.h1>
        ...
        >
          Experience immersion like never before with the new VR Pro Headset. Crystal clear resolution and 360 audio.
        </motion.p>
